# 🎮 Descarga e instalación del launcher en Windows
...
<figure><img src="../.gitbook/assets/image (2) (1) (1).png" alt=""><figcaption><p>En este ejemplo, la versión más reciente es 1.0.2</p></figcaption></figure>
...
4. Una vez realizado esto, el asistente de instalación se abrirá, se mostrará algo así:

<figure><img src="../.gitbook/assets/image (4) (1).png" alt=""><figcaption></figcaption></figure>

5. Selecciona la opción de "Only for me" (Solamente para mí) y presiona "Next" (Siguiente")

<figure><img src="../.gitbook/assets/image (5).png" alt=""><figcaption></figcaption></figure>

6. Ahora el instalador pregunta dónde queremos instalar el programa, es recomendable dejar la ruta predeterminada, simplemente presiona "Install" (Instalar)

<figure><img src="../.gitbook/assets/image (6).png" alt=""><figcaption></figcaption></figure>

7. Una vez se haya instalado exitosamente, el asistente de instalación mostrará una pantalla similar a la imagen adjuntada abajo de este texto, simplemente presiona "Finish" (Finalizar) y el asistente se cerrará.

**Eso es todo, ¡has completado la instalación en Windows! 🎉🎉🥳🥳**
